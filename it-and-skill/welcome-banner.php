            ...
            <div class="grid lg:grid-cols-2 gap-8 items-start">
                <div class="flex flex-col items-center">
                    ...
                    <div class="frame-container mb-6" id="frameContainer">
                        ...
                        <img id="frameOverlay" class="frame-overlay" src="/it-and-skill/basic-foundation.png" alt="Frame" crossorigin="anonymous">
                        
                        <div id="placeholder" class="absolute inset-0 flex flex-col items-center justify-center text-white z-10" style="margin-left:-185px">
                            <img src="https://i.ibb.co.com/R4b2kHxh/istockphoto-2014684899-612x612.jpg" alt="Upload Photo" class="w-20 h-20 mb-4 opacity-50 rounded-lg object-cover" style="margin-top: 285px;">
                ...
                <div class="space-y-6">
                    ...
                    <div class="glass-card rounded-2xl p-6">
                        ...
                        <input type="text" id="nameInput" maxlength="17" placeholder="Write Your Name" class="w-full px-4 py-3 rounded-xl bg-white/20 text-white placeholder-purple-200 focus:outline-none focus:ring-2 focus:ring-purple-400" required>
                    </div>
...
<script>
/* ================= CONFIG ================= */
const FRAME_URL = '/it-and-skill/basic-foundation.png';
...
const PHOTO_AREA = {
    x: CANVAS_WIDTH * 0.17,      // left: 44%
    y: CANVAS_HEIGHT * 0.58,     // top: 25%
    width: CANVAS_WIDTH * 0.33,  // width: 33%
    height: CANVAS_HEIGHT * 0.33 // height: 33%
};
...
async function createFramedImage(){
    ...
    if(name){
        ctx.font = '700 63px Inter';
        ctx.fillStyle = '#21256f';
        ctx.textAlign = 'center';
        ctx.textBaseline = 'bottom';
        ctx.shadowBlur = 8;
        ctx.fillText(name, canvas.width / 1.45, canvas.height * 0.76);
        ctx.shadowBlur = 0;
    }
    // if(branchName){
